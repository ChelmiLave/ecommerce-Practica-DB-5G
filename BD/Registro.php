...
<link rel="stylesheet" href="estilos.css" media="screen">
  ...
  <body class="u-body u-xl-mode" data-lang="es" style="font-size: 16px"><header class="u-clearfix u-gradient u-header u-header" id="sec-dd46"><div class="u-clearfix u-sheet u-sheet-1">
        <a href="inicio.html" class="u-image u-logo u-image-1" data-image-width="1280" data-image-height="853">
  ...
  <div class="row">
    ...
    <div class="container-add">
      ...
      <center><h1 class="container__title">Registra tu usuario</h1></center><br>

      <form method="POST" action="Registro.php" class="container__form">


        <div class="form group" class="container__label"><br>
          <label for="nombre">Nombre </label>
          <input type="text" name="nombre" class="container__input" id="nombre">  
        
          <label for="nombre">Apellido </label>
          <input type="text" name="apellido" class="container__input" id="apellido"><br>  <br>
        ...
        <center>
          <input type="submit" value="Registrar" class="container__submit" name="btn_registrar">

          <input type="submit" value="Actualizar" class="container__submit" name="btn_actualizar">
          <input type="submit" value="Eliminar" class="container__submit" name="btn_eliminar">
        </center>
    ...
    <div class="monitor">
      ...
      include("abrir_conexion.php");
        ...
        if (isset($_POST['btn_registrar'])) 
        {
          ...
          {
            echo "Si quiere registrarse, es necesario que rellene todos los campos";
          }
          else
          {

            mysqli_query($conexion, "INSERT INTO $tabla_db1 (nombre, apellido, direccion, telefono) VALUES ('$nombre','$apellido','$direccion','$telefono')");
        ...
        if (isset($_POST['btn_actualizar'])) 
        {
          ...
          else
          {
            ...
            $resultados = mysqli_query($conexion,"SELECT * FROM $tabla_db1 WHERE direccion='$direccion'");
            while ($consulta = mysqli_fetch_array($resultados)) 
            {
              $existe++;
            }
            if ($existe==0){echo "El usuario con esa direccion no existe";}
            else
            {
        ...
        if (isset($_POST['btn_eliminar'])) 
        {
          ...
          if ($telefono=="") 
          {
            echo "Los usuarios se eliminan por numero de telefono ";
          }
          else
          {
            ...
            {
              $_DELETE_SQL = "DELETE FROM $tabla_db1 WHERE telefono='$telefono'";
    ...
    <section class="u-clearfix u-section-1" id="sec-4b5f">
    ...
    <footer class="u-align-center u-clearfix u-footer u-grey-80 u-footer" id="sec-6b2f"><div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-small-text u-text u-text-variant u-text-1">TIENDA DE ROPA - ecommerce_UPEN<br>
          <br>
        </p>
        <h6 class="u-text u-text-2"> © ecommerce_UPEN 2024. Todos​ los derechos reservados</h6>
      </div></footer>
