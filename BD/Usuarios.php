...
<head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="​Pet shop kamila">
    <meta name="description" content="">
	<title>Usuarios</title>
	<link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="estilos.css">
<link rel="stylesheet" href="Usuarios.css" media="screen">
 ...
 <body class="u-body u-xl-mode" data-lang="es">
  <header class="u-clearfix u-gradient u-header u-header" id="sec-dd46"><div class="u-clearfix u-sheet u-sheet-1">
        <a href="index.html" class="u-image u-logo u-image-1" data-image-width="1280" data-image-height="853">
        ...
        <h2 class="u-align-center u-text u-text-custom-color-1 u-text-1">
          <span class="u-text-body-alt-color" style="font-weight: 700;"> Pet shop</span> kamila
        </h2>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="http://localhost/Proyecto Base de Datos/BD/Usuarios.php">Usuario</a>
</li></ul>
</div>
</li></ul>
          </div>
    ...
    <div class="container-add">
      ...
      <center><h1 class="container__title">Consulta usuarios</h1></center><br>

      <form method="POST" action="Usuarios.php" class="container__form">


        <div class="form group" class="container__label"><br>

          <label for="nombre">Telefono del usuario a consultar </label>
          <input type="number" name="telefono" class="container__input" id="telefono"><br>
          <label for="nombre">Estado que desea consultar</label>
          <input type="text" name="direccion" class="container__input" id="direccion">  
        </div>

        <center>
          <input type="submit" value="Consultar telefono" class="container__submit" name="btn_consultar">
          <input type="submit" value="Consultar estado" class="container__submit" name="btn_consultar_est">
        </center>
    ...
    <div class="monitor">
      ...
      include("abrir_conexion.php");
        ...
        if (isset($_POST['btn_consultar'])) 
        {
          ...
          if($telefono=="")
            { echo "Para consultar algun usuario tiene que introducir el numero de telefono del usuario que busca";}

          else
          {
            $resultados = mysqli_query($conexion,"SELECT * FROM $tabla_db1 WHERE telefono='$telefono'");
            while ($consulta = mysqli_fetch_array($resultados)) 
            {
              ?>
              <div class="container-consulta">
                <div class="table__title">Resultado de la consulta</div>
                <div class="table__header">Nombre</div>
                <div class="table__header">Apellidos</div>
                <div class="table__header">Direccion</div>
                <div class="table__header">Telefono</div>
                <div class="table__item"><?php echo $consulta["nombre"];?></div>
                <div class="table__item"><?php echo $consulta["apellidos"];?></div>
                <div class="table__item"><?php echo $consulta["direccion"];?></div>
                <div class="table__item"><?php echo $consulta["telefono"];?></div>
              </div>
              <?php
              $existe++;
        ...
        if (isset($_POST['btn_consultar_est'])) 
        {
          $direccion = $_POST['direccion'];
          $existe =0;

          if($direccion=="")
            { echo "El campo de estado es obligatorio ";}

          else
          {
            ?><div class="table__title">Resultado de la consulta</div><?php
            $resultados = mysqli_query($conexion,"SELECT * FROM $tabla_db1 WHERE direccion LIKE '%$direccion';");
            while ($consulta = mysqli_fetch_array($resultados)) 
            {
              ?>
              <div class="container-consulta">
            ...
            if ($existe==0) {echo "Estado no registrado. <br> Verifique y vuelva a intentarlo";}
          }
        }
      ?>      
    </div>
  ...
  <br>
      <footer class="u-align-center u-clearfix u-footer u-grey-80 u-footer" id="sec-6b2f"><div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-small-text u-text u-text-variant u-text-1">TIENDA DE ACCESORIOS PARA MASCOTAS - PET SHOP KAMILA<br>
          <br>
        </p>
        <h6 class="u-text u-text-2"> © PET SHOP KAMILA 2022. Todos​ los derechos reservados</h6>
      </div>
      <a class="u-button-style u-nav-link" href="http://localhost/Proyecto Base de Datos/BD/Todos.php">...</a>
    </footer>
